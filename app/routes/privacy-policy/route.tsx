...
Управління цим сайтом itboost.online (далі - «Сайт») здійснюється ФОП Січкарюк Тетяна Василівна, код ЄДРПОУ 2885409868, зареєстрованою відповідно до вимог законодавства України (далі - «Компанія»).
...
Володільцем та розпорядником персональних даних користувачів Сайту є ФОП Січкарюк Тетяна Василівна.

При використанні користувачем сервісів Сайту Компанією здійснюється обробка даних користувача, а саме:
- даних, що надаються користувачем як при заповненні реєстраційних форм (анкет), так і в процесі користування сервісами;
- файли cookie;
- IP-адреси;
...
Microsoft Edge — [privacy.microsoft.com/uk-ua/privacystatement](privacy.microsoft.com/uk-ua/privacystatement)

Mozilla Firefox — [www.mozilla.org/en-US/privacy/websites/#cookies](www.mozilla.org/en-US/privacy/websites/#cookies)

Google Chrome — [https://support.google.com/accounts/answer/61416?hl=ua](https://support.google.com/accounts/answer/61416?hl=ua)

Opera — [help.opera.com/Windows/11.50/en/cookies.html](help.opera.com/Windows/11.50/en/cookies.html)

Safari for macOS — [https://support.apple.com/uk-ua/guide/safari/sfri11471/mac](https://support.apple.com/uk-ua/guide/safari/sfri11471/mac)
...
Щоб звернутися до Компанії з приводу використання файлів cookie, відправте повідомлення по електронній пошті на [itboost.school@gmail.com](mailto:itboost.school@gmail.com).
...
Компанія забезпечує застосування всіх відповідних зобов’язань щодо дотримання конфіденційності, а також технічних і організаційних заходів безпеки для запобігання несанкціонованого або незаконного розголошення або обробки такої інформації та даних від їх випадкової втрати, знищення або пошкодження.
...
Для оновлення, отримання доступу, внесення змін, блокування або видалення свої персональних даних, відкликання згоди на обробку персональних даних, яка були Вами надана Компанії відповідно до цієї Політики, або в разі наявності будь-яких зауважень, побажань або претензій щодо Ваших персональних даних, які обробляються Компанією, будь ласка, звертайтеся до Компанії: по електронній пошті на [itboost.school@gmail.com](mailto:itboost.school@gmail.com).
...
У випадку внесення істотних змін до цієї Політики Компанією буде розміщено повідомлення на Сайті та зазначено термін набрання цими змінами чинності. Якщо протягом зазначеного терміну Ви не відмовитеся від їх прийняття в письмовій формі, це означатиме, що Ви погоджуєтеся з відповідними змінами Політики.
